   ...
   return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden mx-auto max-w-5xl">
        ...
        <div className="bg-gradient-to-r from-cyan-500 to-teal-500 px-6 py-4">
            <h2 className="text-white text-xl font-bold tracking-wide">Users</h2>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
            ...
            <div className="flex gap-1">
                <button
                    ...
                    className="px-3 py-1.5 text-sm rounded-lg border border-gray-200 text-gray-600 hover:bg-cyan-50 disabled:opacity-40 disabled:cursor-not-allowed transition"
                >
                    ← Prev
                </button>
